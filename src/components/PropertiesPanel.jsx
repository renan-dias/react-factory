...
import { Settings2, Layers, Plus, X, Smartphone, ExternalLink } from 'lucide-react';
    ...
    <aside className="right-panel">
      ...
      <div className="panel-scroll">
        {activeTab==='props' ? (
          selectedEl ? (
            <>
              <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14, padding:'10px 12px', background:'var(--glass-light)', borderRadius:'var(--r-md)', border:'1px solid var(--border)' }}>
              ...
              <ElProps el={selectedEl} onChange={props=>updateElement(selectedEl.id, props)} screens={project.screens}/>
            </>
          ) : (
